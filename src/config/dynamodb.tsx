    ...
    try {
        ...
        if (userData.createdEvents && userData.createdEvents.length > 0) {
            if (existingUser) {
                ...
                const updateFields = ['updatedAt = :updatedAt', '#role = :role', '#name = :name', '#mobile = :mobile'];
                ...
                // Only add organization fields if they are provided
                if (userData.organizationName !== undefined) {
                    updateFields.push('organizationName = :organizationName');
                    expressionValues[':organizationName'] = userData.organizationName;
                }
                if (userData.organizationCode !== undefined) {
                    updateFields.push('organizationCode = :organizationCode');
                    expressionValues[':organizationCode'] = userData.organizationCode;
                }
                if (userData.organizationLogo !== undefined) {
                    updateFields.push('organizationLogo = :organizationLogo');
                    expressionValues[':organizationLogo'] = userData.organizationLogo;
                }
                if (userData.branding !== undefined) {
                    updateFields.push('branding = :branding');
                    expressionValues[':branding'] = userData.branding;
                }
